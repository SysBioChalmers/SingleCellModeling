%This code is largely copied from the Human1 paper ("An atlas of human metabolism").
...
x = readtable('F:/DepMap/Achilles_gene_effect.csv');
...
[refModel.grRules, refModel.genes, refModel.rxnGeneMat] = ...
