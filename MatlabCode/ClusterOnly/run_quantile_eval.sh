...
# sbatch -o logs/run_quantile_eval-%A-%a.log --array=1-10 run_quantile_eval.sh
...
matlab -nodesktop -nodisplay -r "generate_norm_models('QuantileData/gtexIndSampQuantile.txt','QuantileData',${SLURM_ARRAY_TASK_ID}); exit" &
