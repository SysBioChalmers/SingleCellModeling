...
# sbatch -o logs/run_evaless_oldalg-%A-%a.log --array=1-40 run_evaless_oldalg.sh
...
matlab -nodesktop -nodisplay -r "getTaskEssentialGenes('DepMap/tINIT/init_models_depmap15-', ${SLURM_ARRAY_TASK_ID}); exit" < /dev/null &
