...
# sbatch -o logs/run_init_depmap_newalg-%A-%a.log --array=1-40 run_gen_depmap_models_newalg.sh
...
matlab -nodesktop -nodisplay -nojvm -r "generate_DepMap_models_new_alg(${SLURM_ARRAY_TASK_ID}); exit" < /dev/null &
