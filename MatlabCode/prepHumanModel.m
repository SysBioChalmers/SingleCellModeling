...
prepDataHumanGEM = prepINITModel(m, taskStruct, spontRxnNames, true, customRxnsToIgnore);
save('../data/prepDataHumanGEM.mat','prepDataHumanGEM');

prepDataHumanGEMEns = prepINITModel(m, taskStruct, spontRxnNames, false, customRxnsToIgnore);
